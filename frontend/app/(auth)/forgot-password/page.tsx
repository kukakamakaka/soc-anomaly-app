      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <motion.div initial={{ scale: 0.7, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
            ...
            className="p-4 bg-gradient-to-br from-blue-500 to-indigo-700 rounded-[1.5rem] shadow-2xl shadow-blue-500/30 ring-1 ring-white/10 mb-5">
                ...
                {token && (
                  <div className="text-left mb-5 p-4 bg-yellow-500/[0.07] border border-yellow-500/20 rounded-xl">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 mt-3 text-[11px] text-blue-400 hover:text-blue-300 font-semibold transition-colors"
                    >
