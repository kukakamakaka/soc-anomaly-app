...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#010b18] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[700px] h-[700px] rounded-full bg-blue-600/10 blur-[130px] pointer-events-none" />
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          >
            <div className="p-4 bg-gradient-to-br from-blue-500 to-indigo-700 rounded-[1.5rem] shadow-2xl shadow-blue-500/30 ring-1 ring-white/10">
              <ShieldAlert className="w-10 h-10 text-white" />
            </div>
            <motion.div
              animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0, 0.3] }}
              transition={{ duration: 2.5, repeat: Infinity, ease: 'easeInOut' }}
              className="absolute inset-0 rounded-[1.5rem] border border-blue-400/30"
            />
          </motion.div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-[10px] text-blue-500 hover:text-blue-400 font-semibold transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
